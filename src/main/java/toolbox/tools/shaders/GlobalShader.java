...
public class GlobalShader implements ToolBoxDisposable {
    ...
    */
    ...
    public void buildShaderProgram(/*int handle, int vertexShader, int fragmentShader, String log,
                                    FloatBuffer matrix, String vertexSource, String fragmentSource, int refCount*/) {
        /*
        To avoid creating duplicate instances of shaders in memory this works by creating a ShaderProgram without the
        constructor then editing the variables manually to create a ShaderProgram.
        This is definitely a bit complicated, but it is intended to be pretty quick and just used to establish the info.
        Also, this is a lot of exceptions... sorry about that.
        */
